...
function getBranchName() {
    ...
    if (path.includes('kampala')) return 'Kampala';
    if (path.includes('entebbe')) return 'Entebbe';
    if (path.includes('jinja')) return 'Jinja';
    return 'Kampala'; // default
}
...
document.getElementById('bookingForm').addEventListener('submit', function(e) {
    ...
    setTimeout(() => {
        ...
        showMessage('success', 
            `✓ Booking Request Submitted for Paradise Hotel ${formData.branch}! ` +
